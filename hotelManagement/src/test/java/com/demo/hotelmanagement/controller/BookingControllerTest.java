 ...
 * 
 * import com.demo.hotelmanagement.dto.BookingRequestDto; import
 * com.demo.hotelmanagement.dto.GuestRequestDto; import
 * com.demo.hotelmanagement.dto.ResponseDto; import
 * com.demo.hotelmanagement.service.BookingService; import
 ...
 * 
 * BookingRequestDto bookingRequestDto; List<BookingRequestDto>
 * bookingRequestDtoList; List<GuestRequestDto> guestRequestDtoList;
 * GuestRequestDto guestRequestDto; ResponseDto responseDto;
 * 
 * @BeforeEach public void setUp() { objectMapper = new ObjectMapper(); mockMvc
 ...
 * 
 * when(bookingService.bookRoom(bookingRequestDtoList, "SINGLE",
 ...
 * .andExpect(status().isOk()) .andExpect(content().string("Booking confirmed"))
 * .andExpect(content().contentType("201"));
